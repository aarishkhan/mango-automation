...
<tag:page dwr="ReportsDwr" js="/resources/emailRecipients.js" onload="init">
  <script type="text/javascript">
    ...
    function init() {
        ReportsDwr.init(function(response) {
            ...
            <c:if test="${!empty param.createName}">
              ReportsDwr.createReportFromWatchlist("${sst:dquotEncode(param.createName)}", [${param.createPoints}], loadReportCB);
            </c:if>
    ...
    function loadReport(reportId, copy) {
        ...
        display("deleteImg", reportId != ${NEW_ID});
        display("copyImg", reportId != ${NEW_ID});
    }
  ...
  <table cellpadding="0" cellspacing="0"><tr><td>
    <div class="borderDiv marB" style="max-height:300px;overflow:auto;">
      ...
      <table cellspacing="1">
        ...
        <tr id="hourglass" class="rowBoot"><td colspan="8" align="center"><tag:img png="hourglass" title="common.loading"/></td></tr>
        <tr id="noReportInstances" class="rowBoot" style="display:none;"><td colspan="8"><fmt:message key="reports.noInstances"/></td></tr>
