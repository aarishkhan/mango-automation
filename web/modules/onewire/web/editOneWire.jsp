...
<%@page import="com.serotonin.m2m2.onewire.vo.OneWirePointLocatorVO"%>
<%@page import="com.serotonin.m2m2.onewire.vo.OneWireDataSourceVO"%>
...
<tag:dataSourceAttrs descriptionKey="dsEdit.1wire.desc" helpId="1wireDS">
  ...
  <jsp:body>
    ...
    <tr>
      ...
      <td class="formField">
        ...
        <tag:timePeriods id="rescanPeriodType" value="${dataSource.rescanPeriodType}" onchange="rescanChanged()" min="true" h="true" d="true" w="true">
