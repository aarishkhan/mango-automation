  ...
  <c:choose>
    ...
    <div class="rowBoot col-lg-12 no-padding-left-right no-margin-left-right"><tag:dateRange/></div>
                  ...
                  <div class="rowBoot col-lg-12 no-padding-left-right no-margin-left-right ">
                    <div class="col-lg-12 no-padding-left-right" colspan="4" id="imageChartDiv"></div>
                 </div>
    ...
    <div class="rowBoot no-padding-left-right no-margin-left-right">
        ...
        <div class="rowBoot no-padding-left-right no-margin-left-right">
            <div class="col-lg-12 no-margin-left-right borderDiv marB">
              ...
              <table col-lg-12 id="eventsTable" cellspacing="1" cellpadding="0" >
                <tr class="col-lg-12 rowHeader no-padding-left-right">
                  <td class="col-xs-1 no-padding-left-right"><fmt:message key="pointDetails.id"/></td>
                  <td class="col-xs-3 no-padding-left-right"><fmt:message key="common.alarmLevel"/></td>
                  <td class="col-xs-3 no-padding-left-right"><fmt:message key="common.activeTime"/></td>
                  <td class="col-xs-2 no-padding-left-right"><fmt:message key="pointDetails.message"/></td>
                  <td class="col-xs-2 no-padding-left-right"><fmt:message key="common.status"/></td>
                  <td class="col-xs-3 no-padding-left-right"><fmt:message key="events.acknowledged"/></td>
                </tr>
