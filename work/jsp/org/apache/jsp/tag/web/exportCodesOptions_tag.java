...
public final class exportCodesOptions_tag
  ...
  private void _jspInit(ServletConfig config) {
    _jspx_tagPool_sst_select_value_onchange_id = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(config);
  ...
  public void doTag() throws JspException, java.io.IOException {
    ...
    if( getOptionList() != null ) {
      _jspx_page_context.setAttribute("optionList", getOptionList());
}
    if( getId() != null ) {
  ...
  private boolean _jspx_meth_c_forEach_0(javax.servlet.jsp.tagext.JspTag _jspx_th_sst_select_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${optionList}", java.lang.Object.class, (PageContext)this.getJspContext(), null));
    _jspx_th_c_forEach_0.setVar("option");
  ...
  private boolean _jspx_meth_sst_option_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_sst_option_0.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${option.key}", java.lang.String.class, (PageContext)this.getJspContext(), null));
    ...
    if (_jspx_eval_sst_option_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        if (_jspx_meth_fmt_message_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_sst_option_0, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
          return true;
  ...
  private boolean _jspx_meth_fmt_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_sst_option_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
          throws Throwable {
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:message
    ...
    _jspx_th_fmt_message_0.setKey((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${option.value}", java.lang.String.class, (PageContext)this.getJspContext(), null));
